...
document.getElementById("name").textContent = "chicka";
const second = 1000,
  minute = second * 60,
  hour = minute * 60,
  day = hour * 24;
let countDown = new Date("Oct 24, 2025 00:00:00").getTime(),
...
new TypeIt("#teks1", {
  strings: [
    "Happy birthday sayangku Chicka 🥰 Semoga hari ini seindah senyummu yang selalu bikin hati adem.",
    "Semoga semua hal baik makin deket ke kamu, dan yang bikin capek-capek cepet minggat yaa.",
    "Thank u udah jadi sosok yang selalu ada, sabar, dan nyebelin dikit tapi gemesin hehe.",
    "Semoga apapun yang kamu impiin, pelan-pelan bisa kejadian. Aku selalu dukung, selalu di sini.",
    "Let’s make more memories bareng, tertawa bareng, dan tentunya tumbuh bareng. Aku sayang kamu!",
  ],
  startDelay: 4000,
  speed: 75,
...
new TypeIt("#teks2", {
  strings: [
    "Entah bareng aku atau nggak, semoga semesta tetap sayang dan jagain kamu, ya.",
    "",
    "Barakallah fii umrik, Chicka sayang 🥺 makasih udah kuat sejauh ini.",
    "",
    "Aku bangga banget sama kamu. Always rooting for you ❤"
  ],  
  startDelay: 1000,
  speed: 75,
  waitUntilVisible: true,
